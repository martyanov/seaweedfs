...
type RemoteConfiguration struct {
	...
	S3V4Signature    bool   `protobuf:"varint,9,opt,name=s3_v4_signature,json=s3V4Signature,proto3" json:"s3_v4_signature,omitempty"`
}

func (x *RemoteConfiguration) Reset() {
	*x = RemoteConfiguration{}
...
func (x *RemoteConfiguration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemoteConfiguration) ProtoMessage() {}

func (x *RemoteConfiguration) ProtoReflect() protoreflect.Message {
	mi := &file_remote_proto_msgTypes[0]
...
// Deprecated: Use RemoteConfiguration.ProtoReflect.Descriptor instead.
func (*RemoteConfiguration) Descriptor() ([]byte, []int) {
	return file_remote_proto_rawDescGZIP(), []int{0}
}

func (x *RemoteConfiguration) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *RemoteConfiguration) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RemoteConfiguration) GetS3AccessKey() string {
	if x != nil {
...
func (x *RemoteConfiguration) GetS3SecretKey() string {
	if x != nil {
...
func (x *RemoteConfiguration) GetS3Region() string {
	if x != nil {
		return x.S3Region
	}
	return ""
...
func (x *RemoteConfiguration) GetS3Endpoint() string {
	if x != nil {
		return x.S3Endpoint
	}
	return ""
...
func (x *RemoteConfiguration) GetS3StorageClass() string {
	if x != nil {
...
func (x *RemoteConfiguration) GetS3ForcePathStyle() bool {
	if x != nil {
...
func (x *RemoteConfiguration) GetS3V4Signature() bool {
	if x != nil {
...
var file_remote_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b,
	0x77, 0x65, 0x65, 0x64, 0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x22, 0xc4, 0x02, 0x0a, 0x13,
	0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x22, 0x0a, 0x0d, 0x73,
	0x33, 0x5f, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01,
	...
	,
	...
	0x61, 0x67, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0x5f, 0x0a, 0x0d, 0x4d, 0x61, 0x70, 0x70, 0x69,
	...
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x77, 0x65, 0x65, 0x64,
	0x2e, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x53, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x57, 0x0a, 0x15, 0x52, 0x65, 0x6d, 0x6f,
	...
	0x64, 0x66, 0x73, 0x2f, 0x77, 0x65, 0x65, 0x64, 0x2f, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_remote_proto_goTypes = []interface{}{
	(*RemoteConfiguration)(nil),   // 0: weed.remote.RemoteConfiguration
	(*RemoteStorageMapping)(nil),  // 1: weed.remote.RemoteStorageMapping
	(*RemoteStorageLocation)(nil), // 2: weed.remote.RemoteStorageLocation
	nil,                           // 3: weed.remote.RemoteStorageMapping.MappingsEntry
}
var file_remote_proto_depIdxs = []int32{
	3, // 0: weed.remote.RemoteStorageMapping.mappings:type_name -> weed.remote.RemoteStorageMapping.MappingsEntry
	2, // 1: weed.remote.RemoteStorageMapping.MappingsEntry.value:type_name -> weed.remote.RemoteStorageLocation
...
func file_remote_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_remote_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RemoteConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
