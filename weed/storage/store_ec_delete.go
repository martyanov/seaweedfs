...
func (s *Store) doDeleteNeedleFromRemoteEcShard(sourceDataNode rpc.ServerAddress, vid needle.VolumeId, collection string, version needle.Version, needleId types.NeedleId) error {
